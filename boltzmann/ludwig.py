...
if __name__ == '__main__':
    ...
    main(txids=txids, rpc=rpc, testnet=testnet, blockstream=blockstream, options=options, max_duration=max_duration, max_txos=max_txos, max_cj_intrafees_ratio=max_cj_intrafees_ratio)
